...
def get_window_sizes():
    ...
    #return [1, 4, 8, 10, 20, 100, 200, 400, 500, 1001] # BDP = 10, up to 1000
    return [1, 2, 4, 10, 20, 50 ,100, 200, 500, 1000]
...
if __name__ == "__main__":
    ...
    for w in window_sizes:
        seq_list.append(tick_and_get_seq_number(w))
    plot(window_sizes, seq_list)
